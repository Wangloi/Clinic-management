                        ...
                        <form id="addAccountForm" method="POST" action="add_account.php" onsubmit="return validatePassword()">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="middle_name" name="middle_name" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="contact_number" name="contact_number" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
